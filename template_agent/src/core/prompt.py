...
def get_system_prompt() -> str:
    ...
    return (
        ...
        "- `create_chart_from_query` — build matplotlib/seaborn charts (bar, line, "
        "scatter, heatmap, box, violin, histogram) from a `run_select_query` result. "
        "Use when the user asks for a plot, chart, or visualization.\n\n"
        "## Behaviour rules\n"
        ...
        "- **For chart requests**, run SQL first, then call `create_chart_from_query` "
        "with the full query result. Mention the chart URL in your answer.\n\n"
        "## Output format\n"
